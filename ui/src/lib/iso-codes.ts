/**
 * ISO 3166-1 numeric → alpha-2 country code lookup, copied verbatim from
 * pkg/web/static/app.js. Used by the choropleth map to translate the
 * numeric country IDs in the world-atlas TopoJSON file to the alpha-2
 * codes the API returns. The map renderer can drop in any country source
 * once you have this conversion.
 */
export const ISO_NUM_TO_A2: Record<string, string> = {
  ...
  "858": "UY", "860": "UZ", "862": "VE", "876": "WF", "882": "WS", "887": "YE", "894": "ZM", "-99": "XK",
};

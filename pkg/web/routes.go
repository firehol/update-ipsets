...
func (s *surfaceRoutes) registerAdmin(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /api/v1/admin/integrity", wrapAdminAuth(s.opts, handleAdminIntegrity(s.baseCtx, s.eng, s.opts.EnableAll, s.outputDir)))
	mux.HandleFunc("GET /api/v1/admin/integrity/refresh", methodNotAllowedHandler(http.MethodPost))
	mux.HandleFunc("POST /api/v1/admin/integrity/refresh", wrapAdminAuth(s.opts, handleAdminIntegrityRefresh(s.baseCtx, s.eng, s.opts.EnableAll, s.outputDir)))
	...
	mux.HandleFunc("POST /api/v1/admin/integrity/reprocess", wrapAdminAuth(s.opts, handleAdminIntegrityReprocess(s.baseCtx, s.eng, s.runner, s.outputDir)))

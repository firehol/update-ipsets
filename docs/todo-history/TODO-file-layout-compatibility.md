...
Costa requested one more authoritative spec focused on:
...
- Costa explicitly called out the legacy production sync path
...
- Legacy bash evidence in `/home/costa/src/firehol/firehol/sbin/update-ipsets`
...
7. The specs MUST NOT hardcode Costa's personal home directory. Paths in specs
   must be:
...
1. History-derivative retained state model
   ...
   - bash keeps one binary snapshot per successful update and unions snapshots
     ...
     - `/home/costa/src/firehol/firehol/sbin/update-ipsets:973-1015`

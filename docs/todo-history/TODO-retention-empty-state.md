...
No user decision required. Costa specified the desired behavior directly: the Retention chart section should not disappear; it should say there are no retention data yet.

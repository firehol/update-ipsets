...
- Verified evidence:
  - legacy cache migration: [pkg/cache/legacy.go](/home/costa/src/firehol/update-ipsets/pkg/cache/legacy.go)
  - config loader still accepts legacy script extraction and migration paths:
    [pkg/config/config.go](/home/costa/src/firehol/update-ipsets/pkg/config/config.go),
    [pkg/config/extract.go](/home/costa/src/firehol/update-ipsets/pkg/config/extract.go)
  - public/web compatibility artifacts still include history/changeset CSVs:
    [pkg/web/server.go](/home/costa/src/firehol/update-ipsets/pkg/web/server.go)
  - legacy bash behavior and filenames are available for comparison in:
    [/home/costa/src/firehol/firehol/sbin/update-ipsets](/home/costa/src/firehol/firehol/sbin/update-ipsets)
...
Made by Costa in this conversation:
...
8. Run a completeness pass:
   - every subsystem checklist item requested by Costa is present
...
- homepage aggregation filter:
  [specs/homepage.md](/home/costa/src/firehol/update-ipsets/specs/homepage.md:253)
- admin health filter:
  [specs/admin-ui.md](/home/costa/src/firehol/update-ipsets/specs/admin-ui.md:154)
- undefined `run immediately`:
  [specs/admin-ui.md](/home/costa/src/firehol/update-ipsets/specs/admin-ui.md:243)
- canonical manual operations are only `recheck` / `reprocess`:
  [specs/pipeline.md](/home/costa/src/firehol/update-ipsets/specs/pipeline.md:519)
- undefined `operator intent` references:
  [specs/design.md](/home/costa/src/firehol/update-ipsets/specs/design.md:160),
  [specs/design.md](/home/costa/src/firehol/update-ipsets/specs/design.md:276)
- family enumeration drift:
  [specs/feeds.md](/home/costa/src/firehol/update-ipsets/specs/feeds.md:16),
  [specs/pipeline.md](/home/costa/src/firehol/update-ipsets/specs/pipeline.md:156)
- state machine lacking explicit disable semantics:
  [specs/pipeline.md](/home/costa/src/firehol/update-ipsets/specs/pipeline.md:623)

...
- The facts-only philosophy in `~/.claude/projects/-home-costa-src-firehol-update-ipsets/memory/feedback_facts_not_labels.md`
- The methodology transparency rule in `feedback_methodology_transparency.md`
- Costa's preferences expressed in this conversation
- The insights spec in `TODO-insights.md`

If Costa wants to change anything (typography sizes, color palette, section order, scroll motion choices), edit this spec before implementation begins.

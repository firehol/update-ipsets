...
| `--verbose` | Enable verbose logs while loading configuration |
...
The command prints no normal output on success. Use `--verbose` only when you
need more detail while the command loads configuration:

...
- [Show facts, not labels](.claude/projects/-home-user-src-firehol-update-ipsets/memory/feedback_facts_not_labels.md)
- [Methodology transparency](.claude/projects/-home-user-src-firehol-update-ipsets/memory/feedback_methodology_transparency.md)
- [No phantom schema fields](.claude/projects/-home-user-src-firehol-update-ipsets/memory/feedback_no_phantom_fields.md)
...
Verdict: delete. Re-add later if/when user decides to curate these for top feeds.

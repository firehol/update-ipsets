...
1. `/home/user/src/firehol/update-ipsets/configs/firehol.yaml` — Main configuration (2858 lines)
2. `/home/user/src/firehol/update-ipsets/pkg/config/config.go` — Go config structs
3. `/home/user/src/firehol/update-ipsets/pkg/config/legacy.go` — Legacy config loader
4. `/home/user/src/firehol/blocklist-ipsets/` — Generated ipset files directory

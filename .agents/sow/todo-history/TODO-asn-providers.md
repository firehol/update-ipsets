...
- **CAIDA prefix2as** (1,085,731 raw lines → 278,544 merged ranges, 3.10B IPv4 covered)
  ...
  - 8.8.8.8 → AS3356 (Level 3 — the upstream that announces the prefix; Google is the actual operator). Different from iptoasn's AS15169 — exactly the kind of cross-validation difference user wants visible.

...
user reported that `dronebl` keeps downloading again immediately after it finishes.
...
- user pointed out the deployment risk correctly: after adding the
...
- This removes the two-place-edit operational trap user called out.

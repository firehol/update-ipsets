...
- Need: user to decide which GitHub org/repo to push to

### 5. Public site design review
- The public site renders but needs user's visual approval
...
- The reference bash implementation exists at `/home/user/src/firehol/firehol/sbin/update-ipsets` and is currently the behavioral source of truth.
- The reference C implementation exists at `/home/user/src/firehol/iprange/` and exposes the standalone `iprange` behavior and binary format compatibility target.
- The current website compatibility targets and generated artifact examples exist under:
  - `/home/user/src/firehol/firehol/html/ipsets/`
  - `/home/user/src/firehol/blocklist-ipsets/`
...
- **update-ipsets bash script** (~8300 lines): `/home/user/src/firehol/firehol/sbin/update-ipsets`
- **iprange C tool** (~3000 lines across 11 .c files): `/home/user/src/firehol/iprange/`
...
- **HTML description pages**: `/home/user/src/firehol/firehol/html/ipsets/`
- **Generated output examples** (blocklist-ipsets repo): `/home/user/src/firehol/blocklist-ipsets/`

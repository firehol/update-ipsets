...
func metricDescriptors() []metricDescriptor {
	return []metricDescriptor{
		...
		gaugeMetric("runtime.process.rss.bytes"),
		gaugeMetric("runtime.process.vms.bytes"),
		gaugeMetric("runtime.process.data.bytes"),
		gaugeMetric("runtime.process.cpu.user.ms"),
		gaugeMetric("runtime.process.cpu.system.ms"),
		gaugeMetric("runtime.process.cpu.total.ms"),
		gaugeMetric("runtime.process.read.bytes"),
		gaugeMetric("runtime.process.write.bytes"),
		gaugeMetric("runtime.process.cancelled_write.bytes"),
		gaugeMetric("runtime.process.read.syscalls"),
		gaugeMetric("runtime.process.write.syscalls"),
		gaugeMetric("runtime.process.open_fds"),

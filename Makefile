...
.PHONY: build test test-tools test-strict fuzz-replay ui-static ui-test ui-e2e ui-budget race coverage coverage-tools bench lint vulncheck staticcheck golangci-lint clean install cross
